...
CV web para estudiantes: **mandan su PDF, la página lo muestra**, más WhatsApp y descarga de tarjeta. Una persona, un link, una tarjeta. Sin cuentas, sin panel.
...
scripts/make_card.py ← PDF 90×50 mm (QR = esa URL)
...
## Generar QR y tarjeta

```text
pip install -r requirements.txt
python scripts/make_card.py --name "Ana Paula Samaniego" --role "Estudiante de Psicología" --url "https://ai-whisperers.github.io/paragu-ai-cv/" -o demos/ana-samaniego/tarjeta.pdf --qr demos/ana-samaniego/qr.png
```

`tarjeta.pdf` es lo que baja el botón **Tarjeta**. El QR es el mismo link que el cliente comparte.
