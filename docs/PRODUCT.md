# Producto — paragu-ai CV

**Estado:** lanzamiento. Precio propuesto, no validado en mercado.  
**Para quién:** estudiantes y recién egresados buscando pasantía / primer laburo.
...
Egresados de curso AIW: Gs. 100.000 (se dice por WhatsApp, no va en el flyer).

## Qué no es

- Un LinkedIn clone con login
- Un listado “mira todos nuestros alumnos”
- Impresión física de tarjetas
- Sitio de negocio paragu-ai (eso es otro producto)

## Relación con paragu-ai

Misma idea de página + WhatsApp, distinta audiencia y cobro: persona, pago único, sin plan mensual.
